...
//console.log('DependancesComponent.constructor');
		...
		cols[1]=new ColonneEcran("nom_tab","Type",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,true,300);
		cols[2]=new ColonneEcran("lib_tab","Type",TypeColEcran.Chaine,true,ModifCol.NonModifiable,true,true,300);
		cols[3]=new ColonneEcran("id","Nom",TypeColEcran.Entier,false,ModifCol.NonModifiable,false,true,100);
		cols[4]=new ColonneEcran("rep","Libellé",TypeColEcran.Chaine,true,ModifCol.Modifiable,true,true,500);
		cols[5]=new ColonneEcran("detail","Détail",TypeColEcran.Detail,true,ModifCol.Modifiable,true,true,90);
		cols[6]=new ColonneEcran("info","Autre",TypeColEcran.Chaine,true,ModifCol.Modifiable,true,true,250);
