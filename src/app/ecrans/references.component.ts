...
export class ReferencesComponent extends EcranGrille
{
	...
	*/
	constructor(public override httpClient: HttpClient, public override formBuilder:UntypedFormBuilder, public override modalService: ModalService,public override activatedRoute:ActivatedRoute)
	{
		...
		cols[8]=new ColonneEcran("id_typublic","Public",TypeColEcran.CleEtrangere,true,ModifCol.Modifiable,false,true,120);
		cols[9]=new ColonneEcran("id_typublicWITH","Public",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,false,120);
		cols[10]=new ColonneEcran("dep","Dépendances",TypeColEcran.Dependances,true,ModifCol.NonModifiable,false,true,250);
		...
		this.m_blocs[0]=new Bloc(this.httpClient,this,"cmpt","cmpt","Comptines","G","exec AZcmptSelect","exec AZcmptMaj @etat@,@id_cmpt@,@nom_cmpt@,@id_instr@,@id_theme@,@id_typublic@","id_cmpt",cols);
		cols=new Array(4);
		...
		cols[3]=new ColonneEcran("dep","Dépendances",TypeColEcran.Dependances,true,ModifCol.Modifiable,false,true,250);
		this.m_blocs[4]=new Bloc(this.httpClient,this,"theme","theme","Thèmes","G","exec AZthemeSelect","exec AZthemeMaj @etat@,@id_theme@,@nom_theme@","id_theme",cols);

		cols=new Array(4);
		cols[0]=new ColonneEcran("etat","etat",TypeColEcran.Chaine,false,ModifCol.NonModifiable,false,true,100);
		cols[1]=new ColonneEcran("id_typublic","id_typublic",TypeColEcran.ClePrimaire,false,ModifCol.NonModifiable,false,true,80);
		cols[2]=new ColonneEcran("nom_typublic","Nom",TypeColEcran.Chaine,true,ModifCol.Obligatoire,true,true,200);
		cols[3]=new ColonneEcran("dep","Dépendances",TypeColEcran.Dependances,true,ModifCol.Modifiable,false,true,250);
		this.m_blocs[5]=new Bloc(this.httpClient,this,"typublic","typublic","Publics","G","exec AZtypublicSelect","exec AZtypublicMaj @etat@,@id_typublic@,@nom_typublic@","id_typublic",cols);
