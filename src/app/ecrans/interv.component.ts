...
//		this.m_classe_boutons=new Array(4);
		...
		cols[0]=new ColonneEcran("id_interv","id_interv",TypeColEcran.ClePrimaire,true,ModifCol.NonModifiable,false,true,100);
		cols[1]=new ColonneEcran("num_interv","N°",TypeColEcran.Chaine,true,ModifCol.NonModifiable,false,true,100);
		cols[2]=new ColonneEcran("date_interv","Date",TypeColEcran.Date,true,ModifCol.NonModifiable,true,true,100);
...
//		cols[6]=new ColonneEcran("fact_interv","Facture",TypeColEcran.BooleenNonModif,true,ModifCol.NonModifiable,true,true,80);
		...
		cols[3]=new ColonneEcran("id_seance","id_seance",TypeColEcran.Chaine,true,ModifCol.Obligatoire,false,true,100);
		cols[4]=new ColonneEcran("id_seanceWITH","Loge",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,false,100);
		cols[5]=new ColonneEcran("id_lieu","id_lieu",TypeColEcran.Chaine,true,ModifCol.Obligatoire,false,true,100);
		cols[6]=new ColonneEcran("id_lieuWITH","Loge",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,false,100);
		cols[7]=new ColonneEcran("comm_interv","Commentaire",TypeColEcran.Chaine,true,ModifCol.Obligatoire,true,true,100);
		...
		cols[2]=new ColonneEcran("id_interv","id_interv",TypeColEcran.Entier,true,ModifCol.NonModifiable,false,true,100);
		cols[3]=new ColonneEcran("id_intervWITH","Intervention Date/Lieu",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,true,100);
