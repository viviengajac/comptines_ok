...
//		this.m_classe_boutons=new Array(4);
		...
		cols[5]=new ColonneEcran("comm_interv","Commentaire",TypeColEcran.Chaine,true,ModifCol.NonModifiable,true,true,600);
		...
		//cols[5]=new ColonneEcran("id_typublic","Public",TypeColEcran.CleEtrangere,true,ModifCol.Modifiable,false,true,120);
		//cols[6]=new ColonneEcran("id_typublicWITH","Public",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,false,120);
		...
		this.m_blocs[2]=new Bloc(httpClient,this,"interv","seance_cmpt","Déroulé","G","exec AZinterv__seance_cmptSelect @id@","exec AZinterv__seance_cmptMaj @etat@,@id_seance_cmpt@,@id_seance@,@id_cmpt@,@numero@,@seq@,@intermede@","id_seance_cmpt",cols);
		...
		//cols[6]=new ColonneEcran("id_typublic","Public",TypeColEcran.CleEtrangere,true,ModifCol.Modifiable,false,true,120);
		//cols[7]=new ColonneEcran("id_typublicWITH","Public",TypeColEcran.Chaine,false,ModifCol.NonModifiable,true,false,120);
